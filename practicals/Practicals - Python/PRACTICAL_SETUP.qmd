...
The exercises for today are meant to be done in the terminal (not jupyter). We'll start using jupyter more tomorrow.

Exercise 0.1

We are going to use github repos to present and compare each assignment within groups.
Create a github repo for this course. Name it `BIO511_python_2025_<My-Name>`. Create a folder for the first assignment in your new git repo and push your solutions for Exercise 0.2 below. This should allow you to easily show the rest of the group what you did tomorrow.
