...
2. How many genomes can be considered ESBL strains? (You may need to look up what characterizes an ESBL strain), you should also make sure that the hardcoded labels are suitable (ie change them from label1 and label2 to something more meaningful)
