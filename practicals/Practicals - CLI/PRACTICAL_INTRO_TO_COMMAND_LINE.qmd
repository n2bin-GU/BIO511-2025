...
#NB! In zsh, the default shell of MacOS, this command doesn't work. You instead have to use 
man ls 
#(you exit the manual by typing "q")
...
::: {.callout-note}
## Before you start
Make sure you navigate to the CLI_intro directory again so that you know where the files you have created are :)
:::
...
mv gene_annotation.csv raw_data/{__}.csv
